...
- Public read where appropriate (settings, legal docs)
*/
...
INSERT INTO settings (key, value, category, data_type, description, is_public) VALUES
  ('site_name', 'KUBATA KIÉ', 'GENERAL', 'TEXT', 'Nome do site', true),
  ('site_description', 'A plataforma imobiliária de Angola', 'GENERAL', 'TEXT', 'Descrição do site', true),
  ('default_currency', 'AOA', 'GENERAL', 'TEXT', 'Moeda padrão', true),
  ('max_images_per_property', '20', 'PROPERTIES', 'NUMBER', 'Máximo de imagens por imóvel', false),
  ('require_approval', 'true', 'PROPERTIES', 'BOOLEAN', 'Exigir aprovação de anúncios', false),
  ...
  ('services_enabled', 'false', 'FEATURE_FLAGS', 'BOOLEAN', 'Serviços ativos', true),
  ('advertising_enabled', 'false', 'FEATURE_FLAGS', 'BOOLEAN', 'Publicidade ativa', true),
  ('subscriptions_enabled', 'false', 'FEATURE_FLAGS', 'BOOLEAN', 'Subscrições ativas', true),
  ('advanced_analytics_enabled', 'false', 'FEATURE_FLAGS', 'BOOLEAN', 'Analytics avançado ativo', false)
...
INSERT INTO legal_documents (type, title, content, version, is_active) VALUES
  ('TERMS', 'Termos e Condições', 'Os presentes Termos e Condições regulam a utilização da plataforma KUBATA KIÉ. Ao utilizar a plataforma, concorda com estes termos.', 1, true),
  ('PRIVACY', 'Política de Privacidade', 'A sua privacidade é importante para nós. Esta política descreve como recolhemos, utilizamos e protegemos os seus dados pessoais.', 1, true),
  ('COOKIES', 'Política de Cookies', 'Esta política descreve o uso de cookies na plataforma KUBATA KIÉ.', 1, true),
  ('MARKETPLACE_RULES', 'Regras do Marketplace', 'Regras para compradores e vendedores na plataforma KUBATA KIÉ.', 1, true),
  ('PROPERTY_RULES', 'Regras de Anúncios', 'Regras para publicação de anúncios de imóveis.', 1, true),
  ('PAYMENT_RULES', 'Regras de Pagamento', 'Regras para pagamentos na plataforma.', 1, true),
  ('CANCELLATION', 'Política de Cancelamento', 'Política de cancelamento e reembolso.', 1, true),
  ('SERVICE_RULES', 'Regras de Serviços', 'Regras para prestação de serviços.', 1, true)
